...
> Внутри одного региона вы **не можете** одновременно принимать и внешние платежи, и классические платежи через App Store. Но можно использовать внешние платежы для РФ, а для других регионов - класические.
...
Заявка это что-то вроде анкеты, практически все поля заполняются автоматически. Подавать заявку [по этой ссылке](https://developer.apple.com/contact/request/storekit-external-entitlement-ru). Ваш аккаунт должен быть компании, без Small Business Programm.
