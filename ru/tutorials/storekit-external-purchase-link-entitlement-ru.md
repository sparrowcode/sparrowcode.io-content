...
> Чтобы принимать оплаты через App Store Payments, можно [открыть компанию в Великобритании](https://sparrowcode.io/ru/business/company_registration). Мы работем под ключ — ведём документы, получаем DUNS и помогаем получить банковский счет
